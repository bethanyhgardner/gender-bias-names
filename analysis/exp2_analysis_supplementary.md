...
```
    ...
    ##  Participant (Intercept) 0.1024   0.3199  
    ##  Item        (Intercept) 1.7798   1.3341  
    ## Number of obs: 9105, groups:  Participant, 1322; Item, 105
    ## 
    ## Fixed effects:
    ##                             Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept)                  -0.7854     0.1504  -5.221 1.78e-07 ***
    ## Conditionlast vs first/full   1.9225     0.3422   5.619 1.92e-08 ***
    ## Conditionfirst vs full       -0.2003     0.3439  -0.582     0.56    
    ## ---
...
```
    ...
    ## Fixed effects:
    ##                 Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept)      -2.0543     0.2924  -7.025 2.14e-12 ***
    ## Condition_Last1   1.8558     0.3293   5.635 1.75e-08 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Correlation of Fixed Effects:
...
```
    ...
    ## Conditionfirst vs full                      -0.25775    0.16130  -1.598
    ## GenderRatingCentered                         0.77906    0.03558  21.894
    ## GenderRatingSquared                         -0.01296    0.01963  -0.661
    ## Conditionfirst vs full:GenderRatingCentered -0.06125    0.06977  -0.878
    ## Conditionfirst vs full:GenderRatingSquared   0.01120    0.03922   0.286
    ##                                             Pr(>|z|)    
    ## (Intercept)                                   0.0849 .  
...
```
    ...
    ## Scaled residuals: 
    ##     Min      1Q  Median      3Q     Max 
    ## -3.6666 -0.4635 -0.2879  0.5557  4.6794 
    ## 
    ## Random effects:
    ##  Groups      Name        Variance Std.Dev.
    ...
    ## Fixed effects:
    ##                                                Estimate Std. Error z value
    ## (Intercept)                                    -0.85063    0.15275  -5.569
    ## Conditionlast vs first/full                     2.02310    0.34744   5.823
    ## Conditionfirst vs full                         -0.20017    0.34948  -0.573
    ## SubjGenderMaleNM_M                             -0.12522    0.06205  -2.018
    ## Conditionlast vs first/full:SubjGenderMaleNM_M -0.41780    0.14249  -2.932
    ## Conditionfirst vs full:SubjGenderMaleNM_M       0.09225    0.14020   0.658
    ##                                                Pr(>|z|)    
    ## (Intercept)                                    2.57e-08 ***
    ## Conditionlast vs first/full                    5.78e-09 ***
    ## Conditionfirst vs full                          0.56679    
    ## SubjGenderMaleNM_M                              0.04358 *  
    ## Conditionlast vs first/full:SubjGenderMaleNM_M  0.00337 ** 
    ## Conditionfirst vs full:SubjGenderMaleNM_M       0.51055    
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Correlation of Fixed Effects:
    ...
    ## SbjGndMNM_M -0.021  0.001 -0.002              
    ## Cvf/:SGMNM_  0.003 -0.022 -0.001 -0.196       
...
```
    ...
    ## Fixed effects:
    ##                            Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept)                -0.22873    0.15430  -1.482 0.138233    
    ## FFdummy                    -1.95733    0.33427  -5.855 4.76e-09 ***
    ## SubjGenderMaleNM_M         -0.26325    0.07015  -3.753 0.000175 ***
    ## FFdummy:SubjGenderMaleNM_M  0.41379    0.14108   2.933 0.003358 ** 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Correlation of Fixed Effects:
...
```
    ...
    ## Random effects:
    ##  Groups      Name        Variance Std.Dev.
    ##  Participant (Intercept) 0.1833   0.4281  
    ##  Item        (Intercept) 1.8318   1.3535  
    ## Number of obs: 8841, groups:  Participant, 1263; Item, 105
    ## 
    ## Fixed effects:
    ##                           Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept)                -2.1861     0.2965  -7.374 1.66e-13 ***
    ## Ldummy                      1.9574     0.3340   5.859 4.64e-09 ***
    ## SubjGenderMaleNM_M          0.1505     0.1224   1.230  0.21878    
...
```
    ...
    ## SubjGenderMaleNM_M:Conditionfirst vs full                         0.13644
    ## GenderRatingCentered:SubjGenderMaleNM_M:Conditionfirst vs full    0.08997
    ##                                                                 z value
    ## (Intercept)                                                    -2.63816
    ## GenderRatingCentered                                           21.98058
    ## SubjGenderMaleNM_M                                             -3.34468
    ## Conditionfirst vs full                                         -1.67985
    ## GenderRatingCentered:SubjGenderMaleNM_M                        -3.31992
    ## GenderRatingCentered:Conditionfirst vs full                    -0.81075
    ## SubjGenderMaleNM_M:Conditionfirst vs full                       0.93526
    ## GenderRatingCentered:SubjGenderMaleNM_M:Conditionfirst vs full -1.29270
    ##                                                                Pr(>|z|)
    ## (Intercept)                                                       0.008
    ...
    ## Conditionfirst vs full                                         0.092986 .  
    ## GenderRatingCentered:SubjGenderMaleNM_M                        0.000900 ***
    ## GenderRatingCentered:Conditionfirst vs full                    0.417509    
    ## SubjGenderMaleNM_M:Conditionfirst vs full                      0.349654    
    ## GenderRatingCentered:SubjGenderMaleNM_M:Conditionfirst vs full 0.196115    
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Correlation of Fixed Effects:
